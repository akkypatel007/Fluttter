...
// -- Splash Screen Text
const String tAppName = "Build Your Career";
...
const String tWelcomeSubTitle = "Where are you now?";
const String tWelcomeEndTitle = "For Organisation looking for\nIndividuals";

// -- SignIn and SignUp
const String tSASTitle = "Find your DREAM CAREER";
const String tSASSubTitle =
    "Let's put your creativity on the development highway.";
const String tSASEndTitle = "Let's Get you Started!";

// -- Login Screen Text
const String tLoginTitle = "Welcome Back,";
const String tLoginSubTitle = "If opportunity doesn't knock, build a door.";
...
const String tDashboardTitle = "Hey, Whats'up..?";
const String tDashboardHeading = "Explore Your Interest";
const String tDashboardSearch = "Search...";
const String tDashboardBannerTitle1 = "Flutter for beginners";
const String tDashboardBannerTitle2 = "DART";
