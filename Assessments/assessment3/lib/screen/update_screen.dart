...
class UpdateScreen extends StatefulWidget {
  UpdateScreen({Key? key, required this.docID}) : super(key: key);
  final String docID;

  @override
  State<UpdateScreen> createState() => _CashCalculatorState();
}

class _CashCalculatorState extends State<UpdateScreen> {
  final CollectionReference _cash =
      FirebaseFirestore.instance.collection("cash");

  Future<void> _updateUser(id, name, denominations, quantity, createddate,
      createdtime, totals, totalAmount) {
    return _cash
        .doc(id)
        .update({
          'name': name,
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          print(data);
          var name = data!['Name'];
          var quantity = data['Quantities'];
          var Denominations = data['Denominations'];
          var createddate = data['Created Date'];
          var createdtime = data['Created Time'];
          return Scaffold(
            appBar: AppBar(
